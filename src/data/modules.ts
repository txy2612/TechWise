  ...
  lessons: [
    {
      ...
      moduleId: 'module-smartphone',
      order: 1,
      titleEn: 'Home Screen and Apps',
      titleZh: '主屏幕和应用',
      descriptionEn: 'Navigate your phone home screen',
      descriptionZh: '浏览手机主屏幕',
      contentType: 'tutorial',
      estimatedMinutes: 10,
      requiredScore: 80,
      steps: [],
      quiz: { id: 'quiz-smartphone-1', lessonId: 'lesson-smartphone-1', passingScore: 80, questions: [] },
    },
    {
      id: 'lesson-smartphone-2',
      moduleId: 'module-smartphone',
      order: 2,
      titleEn: 'Making Calls and Texts',
      titleZh: '拨打电话和发短信',
      descriptionEn: 'Learn to call and text',
      descriptionZh: '学习打电话和发短信',
      contentType: 'simulation',
      estimatedMinutes: 12,
      requiredScore: 80,
      steps: [],
      quiz: { id: 'quiz-smartphone-2', lessonId: 'lesson-smartphone-2', passingScore: 80, questions: [] },
    },
    {
      ...
      titleZh: '拍照',
      descriptionEn: 'Use your camera effectively',
      descriptionZh: '有效使用相机',
      contentType: 'practice',
      estimatedMinutes: 10,
      requiredScore: 80,
      steps: [],
      quiz: { id: 'quiz-smartphone-3', lessonId: 'lesson-smartphone-3', passingScore: 80, questions: [] },
    },
    {
      id: 'lesson-smartphone-4',
      moduleId: 'module-smartphone',
      order: 4,
      titleEn: 'Settings and Updates',
      titleZh: '设置和更新',
      descriptionEn: 'Manage phone settings',
      descriptionZh: '管理手机设置',
      contentType: 'tutorial',
      estimatedMinutes: 15,
      requiredScore: 80,
      steps: [],
      quiz: { id: 'quiz-smartphone-4', lessonId: 'lesson-smartphone-4', passingScore: 80, questions: [] },
    },
  ],
